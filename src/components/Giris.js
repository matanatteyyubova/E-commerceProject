       ...
       <div className="login-sec">
            ...
            <div className="login-text">
                ...
                <input type="checkbox" id="check1" name="check1" value="meni xatirla" />
                 ...
                 <br /> 
                  <button id='submit' type='submit'>Daxil ol</button>
 
                  <div className="social">
                      <button id='face'> <i class="fa-brands fa-facebook-f"></i>   Facebook hesabınızla daxil olun</button> <br />
                      <button id='google'><i class="fa-brands fa-google-plus-g"></i> Google hesabınızla daxil olun</button>
                  </div>
                  <br /><br />
                  <div className="info">
                     <Link to="/qeydiyyat"  style={{ textDecoration: "none" }}> <p>Hesab yarat</p></Link>
